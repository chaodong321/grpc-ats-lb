...
class SysInfo final {
 public:
  ...
  typedef WithAsyncMethod_getCpuUsage<WithAsyncMethod_getCpuTemp<WithAsyncMethod_getMemUsage<WithAsyncMethod_getNicInfo<WithAsyncMethod_getHostName<WithAsyncMethod_getIpInfo<WithAsyncMethod_getCpuModel<WithAsyncMethod_getCpuCores<WithAsyncMethod_getMemTotal<WithAsyncMethod_getEthCtrlInfo<Service > > > > > > > > > > AsyncService;
  template <class BaseClass>
