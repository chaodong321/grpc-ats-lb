...
Status RaltServiceImpl::getCpuUsage (ServerContext* context, const GetCpuUsageReq* request, GetCpuUsageRsp* reply)
{
...
Status RaltServiceImpl::getCpuTemp (ServerContext* context, const GetCpuTempReq* request, GetCpuTempRsp* reply)
{
...
Status RaltServiceImpl::getMemUsage (ServerContext* context, const GetMemUsageReq* request, GetMemUsageRsp* reply)
{
...
Status RaltServiceImpl::getNicInfo (ServerContext* context, const GetNicInfoReq* request, GetNicInfoRsp* reply)
{
